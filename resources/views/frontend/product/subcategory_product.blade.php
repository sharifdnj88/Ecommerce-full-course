                ...
                <div class="breadcrumb-wrap">
                    <nav aria-label="breadcrumb">
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#">{{$subcategory->subcategory_name}}</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
                ...
                <div class="shop-sidebar-wrap mt-md-28 mt-sm-28">
                    ...
                    <div class="sidebar-widget mb-30">
                        <div class="sidebar-category">
                            <ul>
                                <li class="title"><i class="fa fa-bars"></i>Childcategories</li>
                                @foreach ($childcategory as $item)
                                    <li><a href="{{route('childcategorywise.product',$item->id)}}">{{$item->childcategory_name}}</a></li>                                    
                                @endforeach
                            </ul>
                        </div>
                    </div>
