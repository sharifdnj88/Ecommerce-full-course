                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group font-weight-bold">
                                                ...
                                                <input name="stock_quantity" type="text" value="{{ old('stock_quantity') }}" class="form-control">
                                            </div>    
                                            
                                            
                                            <div class="form-group font-weight-bold">
                                                <label>Purchase Price <span class="text-danger">*</span> </label>
                                                <input name="purchase_price" type="text" value="{{ old('purchase_price') }}" class="form-control">
                                            </div>                                      
                                            ...
                                            <div class="form-group font-weight-bold">
                                                ...
                                                <input name="color" type="text" value="{{ old('color') }}" class="form-control" data-role="tagsinput">
                                            </div>                                       
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group font-weight-bold">
                                                ...
                                                <input name="unit" type="text" value="{{ old('unit') }}" class="form-control">
                                            </div>                                            
                                            <div class="form-group font-weight-bold">
                                            ...
                                            <div class="form-group font-weight-bold">
                                                ...
                                                <input name="selling_price" type="text" value="{{ old('selling_price') }}" class="form-control" required>
                                            </div>
                                            
                                            <div class="form-group font-weight-bold">
                                                <label>Tags <span class="text-danger">*</span> </label> <br>
                                                <input name="tags" type="text" value="{{ old('tags') }}" class="form-control" data-role="tagsinput">
                                            </div>
                                            <div class="form-group font-weight-bold">
                                                <label>Size <span class="text-danger">*</span> </label> <br>
                                                <input name="size" type="text" value="{{ old('size') }}" class="form-control" data-role="tagsinput">
                                            </div>
