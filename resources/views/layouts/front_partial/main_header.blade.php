                                    ...
                                    <ul class="megamenu">
                                        ...
                                        <li>
                                            <div class="banner-fixed menu-banner menu-banner2">
                                                <figure>
                                                    <img src="{{ asset('frontend') }}/images/menu/banner-2.jpg" alt="Menu Banner"
                                    ...
                                    <ul class="megamenu">
                                        ...
                                        <li>
                                            <div class="menu-banner banner-fixed menu-banner3">
                                                <figure>
                                                    <img src="{{ asset('frontend') }}/images/menu/banner-3.jpg" alt="Menu Banner"
                                    ...
                                    <ul class="megamenu">
                                        ...
                                        <li>
                                            <div class="menu-banner banner-fixed menu-banner4">
                                                <figure>
                                                    <img src="{{ asset('frontend') }}/images/menu/banner-4.jpg" alt="Menu Banner"
                                        ...
                                        <li class="row">
                                            <div class="col-6">
                                                <div class="banner banner-fixed menu-banner5 br-xs">
                                                    <figure>
                                                        <img src="{{ asset('frontend') }}/images/menu/banner-5.jpg" alt="Banner"
                                            ...
                                            <div class="col-6">
                                                <div class="banner banner-fixed menu-banner5 br-xs">
                                                    <figure>
                                                        <img src="{{ asset('frontend') }}/images/menu/banner-6.jpg" alt="Banner"
                                                            width="410" height="123"
